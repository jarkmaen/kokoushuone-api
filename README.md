...
Rajapinnassa on kolme endpointtia:

- `POST /api/reservations` varausten luomiseen.
- `DELETE /api/reservations/:id` varausten perumiseen.
- `GET /api/reservations/rooms/:room` kokoushuoneiden varausten listaamiseen.
...
```
GET http://localhost:3000/api/reservations/rooms/A1
```

## Asentaminen ja käynnistäminen

Sovelluksen asentaminen vaatii, että sekä [Git](https://git-scm.com/) että [Node.js](https://nodejs.org/) (jonka mukana tulee [npm](https://www.npmjs.com/)) on asennettu tietokoneellesi. Komentoriviltä:

```
# Kloonaa repositorio ja mene juurihakemistoon
...
# Luo .env tiedosto server hakemistoon ja lisää siihen:
PORT=3000
...
Palvelimen pitäisi olla nyt käynnissä osoitteessa http://localhost:3000.
